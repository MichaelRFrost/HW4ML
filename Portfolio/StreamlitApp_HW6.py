...
MODEL_INFO = {
        ...
        "keys": ['sentiment_textblob', 'ADBE', 'GOOG', 'AMZN', 'Lag_Return_1'],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ['sentiment_textblob', 'ADBE', 'GOOG', 'AMZN', 'Lag_Return_1']]
}
